...
public class DirectoryBrowser {
    ...
    private static void createAndShowGUI() {
        try {
            ...
            UIManager.put("swing.plaf.metal.controlFont", new Font("SansSerif", Font.PLAIN, 16));
            ...
            UIManager.put("swing.plaf.metal.textAreaFont", new Font("Monospaced", Font.PLAIN, 14));
        } catch (Exception e) {
            e.printStackTrace();
        }
